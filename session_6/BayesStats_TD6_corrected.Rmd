...
98% of the variation is now due to the sites. Is that a large change? If so what could it be due to? -> Due to the fact that

* Plenty of sites with zero values
* Poisson variation has "sucked in" a part of residual variation
...
Now we've got 78% of the variance explained by the site. 
